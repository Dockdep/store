<?php
    ...
    return [
        ...
        'Text'                                                => 'Комментарий',
        'Entity'                                              => 'Модель',
        'Entity ID'                                           => 'Идентификатор модели',
        'Parent ID'                                           => 'Родитель',
        'Status'                                              => 'Статус',
        'Level'                                               => 'Уровень',
        'User'                                                => 'Пользователь',
        ...
        'Date delete'                                         => 'Дата удаления',
        'Comment parent'                                      => 'Родитель',
        'Comment related'                                     => 'Связзанный комментарий',
        ...
        'Active'                                              => 'Включён',
        'Deleted'                                             => 'Удален',
        'Comment posted'                                      => 'Комментарий успешно добавлен и появится после проверки администрацией.',
